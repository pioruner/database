...
const (
	TransferService_Ping_FullMethodName = "/grpc.TransferService/Ping"
)
...
func (c *transferServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
...
func (UnimplementedTransferServiceServer) Ping(context.Context, *PingRequest) (*PingResponse, error) {
...
func _TransferService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransferServiceServer).Ping(ctx, req.(*PingRequest))
	}
